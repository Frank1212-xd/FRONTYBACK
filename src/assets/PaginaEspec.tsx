...
const PaginaEspec = () => { 
  ...
  return ( 
    <div className="text-center vh-100 d-flex flex-column justify-content-center align-items-center bg-dark"> 
        <Link to="/RegaloLista" className="btn btn-link text-white btn-negra"> 
        Lista de Regalos
      </Link> 
<button
        className="btn btn-link text-white botonnegro"
